...
Implemented data cleaning and validation steps including header removal, text normalization, currency symbol cleanup, numeric field handling, and record filtering to ensure data accuracy and consistency. 

The pipeline generated three analytical reports using awk: 
1. Transaction Summary: Aggregates purchases by state, age group, and gender.
